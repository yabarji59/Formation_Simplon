<div class="content-plan">
  ...
  <span class="bouton" id="bouton_texte" onclick="javascript:afficher_cacher('texte');">découvrir les pages</span>
    <div id="texte" class="texte">
            <a href="index.php"><h2>1. Accueil</h2>
             <p>
                      Sur cette page, vous y trouverez les actualités, des sondages, un raccourci vers la page Facebook ainsi qu'un bref aperçu du village et 
                      de son histoire
            </p>
            </a>

          <a href="index.php?page=documents"><h2>2. Documents</h2>
        
                  <p>
                  Sur cette page, vous y trouverez des documents photos et vidéos liés à la santé, à l'Histoire, au conseil, à l'économie du village disponibles au téléchargement
                  </p>
          
            </a>
          <a href="index.php?page=equipe"><h2>3. L'équipe communale</h2>
          ...
          <a href="index.php?page=articles"><h2>5. Articles</h2>
              ...
              <p>
              Sur cette page, vous y trouverez des renseignements supplémentaires d'ordre culturel, sanitaire, social, politique... 
              </p>
          ...
          <a href="index.php?page=admin"><h2>11. Administration | ( privé )</h2>
